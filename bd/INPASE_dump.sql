...
(`idevete`, `ideve`, `descripcion`, `fecha_registro`, `fecha_edicion`, `estado_registro`) VALUES
(NULL, 1, 'Pagos', NOW(), NOW(), 1),
(NULL, 1, 'Gratis', NOW(), NOW(), 1),
(NULL, 1, 'Gratis con Horario', NOW(), NOW(), 1),
(NULL, 2, 'Pagos con Consumición', NOW(), NOW(), 1),
(NULL, 2, 'Hombres', NOW(), NOW(), 1),
(NULL, 2, 'Mujeres', NOW(), NOW(), 1);
